...
def test_poll_interval_seconds_from_env_uses_default_when_unset(monkeypatch) -> None:
...
def test_poll_interval_seconds_from_env_parses_override(monkeypatch) -> None:
